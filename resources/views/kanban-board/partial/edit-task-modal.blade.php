        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ $actionUrl }}" method="POST">
                    ...
                    <!-- Input Tersembunyi untuk ID Kanban Board -->
                    ...
                    <!-- Pilihan Pengguna -->
                    <div class="mb-3">
                        <label for="employee_id" class="form-label">Tetapkan ke Pengguna</label>
...
<style>
    ...
    .select2-container {
        width: 100% !important;
        /* Ensures select2 takes the full width */
    }

    .select2-selection__rendered {
        line-height: 2.4rem;
        /* Adjust to match bootstrap input height */
    }
    ...
    .select2-container--default .select2-selection--single {
        ...
        /* Consistent border with bootstrap */
    }
