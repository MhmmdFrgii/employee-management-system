  ...
  <div class="modal fade" id="editSalariesModal{{ $salary->id }}" tabindex="-1"
      aria-labelledby="editSalariesModalLabel{{ $salary->id }}" aria-hidden="true" data-bs-backdrop="static">
                  ...
                  <form action="{{ route('salaries.update', $salary->id) }}" method="POST">
                      ...
                      <div class="mb-3">
                          ...
                          <input type="text" name="amount"
                              class="form-control @error('amount') is-invalid @enderror" readonly id="edit_amount"
                      ...
                      <div class="mb-3" style="display: none;">
                          ...
                          <select name="type" id="edit_type"
                              ...
                              <option value="income" {{ old('type', $salary->type) == 'income' ? 'selected' : '' }}>
                                  Pemasukan</option>
                              <option value="expense" {{ old('type', $salary->type) == 'expense' ? 'selected' : '' }}>
                                  Pengeluaran</option>
                          </select>
                          @error('type')
                              <div class="invalid-feedback">{{ $message }}</div>
